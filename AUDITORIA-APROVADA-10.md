# WAGNER.OS v3.0.0 — aprovação de release 10/10
...
- E2E aprovado em desktop e mobile para scroll do mouse, chat, apresentação, topo, WhatsApp/currículo e menu.
...
O funcionamento online do Gemini, Resend e Upstash depende das credenciais e da disponibilidade desses provedores. A release não contém secrets. Configure-os exclusivamente no ambiente da Vercel conforme `.env.example`.
