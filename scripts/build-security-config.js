...
var config = {
  ...
  headers: [
    ...
    { source: '/(.*\\.(?:css|js))', headers: [
      { key: 'Cache-Control', value: 'public, max-age=0, must-revalidate' },
      { key: 'Vercel-CDN-Cache-Control', value: 'max-age=86400, stale-while-revalidate=604800' }
    ] },
    { source: '/(.*\\.(?:json|txt|pdf|webp|avif|png|jpg|jpeg|svg|woff2|mp4|webm))', headers: [
      { key: 'Cache-Control', value: 'public, max-age=3600, stale-while-revalidate=86400' },
      { key: 'Vercel-CDN-Cache-Control', value: 'max-age=604800, stale-while-revalidate=2592000' }
    ] }
  ],
  rewrites: [
